...
export default function Hero() {
  return (
    <section className="relative text-white bg-slate-950 bg-hero-pattern bg-contain bg-no-repeat bg-bottom p-6 pb-0">
      <div className="flex flex-col items-center justify-center mx-auto max-w-prose">
        <p className="px-3 pb-0.5 text-gray-200 bg-slate-800 rounded-full z-10 lg:mb-3 mb-6">TCET Open Source</p>
        ...
        <button className="group flex items-center justify-center text-white gap-x-2 p-2 pl-4 md:mb-0 mb-3 shadow-1xl shadow-indigo-400 semibold rounded-full bg-indigo-600 hover:scale-110 hover:cursor-pointer hover:bg-indigo-500 duration-300">
          View Projects
          <div className="group-hover:bg-indigo-600 duration-300 bg-indigo-800 p-2 rounded-full">
