...
COO is the highest operational position in the organization. COO oversees all non-technical work going on in the organization, which includes event planning and execution, handlin` of the organization's presence on the internet via social media, and all the official paperwork that goes in officiating the various technical and non-technical activities the organization is conducting or is involved in.

### CFO - CHIEF FINANCIAL OFFICER
**Current Bearer - [ASIMVAIBHAV TIWARI](https://www.linkedin.com/in/asimvaibhav/)**

CFO holds a crucial role in managing the organization's financial health, sustainability, and transparency. CFO is responsible for maintaining financial transparency, managing resources effectively, and ensuring the organization's long-Term Financial Sustainability. Their role plays a critical part in supporting our projects and initiatives that advance the organization's mission and benefit the broader community. 
