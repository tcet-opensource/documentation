...
<figure>
    <center><img src={Popup} style={{ border: "2px solid gray", width: "600px", height: "400px" }} /></center>
...
<figure>
    <center><img src={Hero} style={{ border: "2px solid gray", width: "600px", height: "400px" }} /></center>
