...
After successfully implementing the [**Footer component**](footer) of the [**TCET Linux Website**](https://linux.tcetmumbai.in/) , the next step is to move forward with the implementation of the [**Copy to Clipboard component**](copy-to-clipboard).
