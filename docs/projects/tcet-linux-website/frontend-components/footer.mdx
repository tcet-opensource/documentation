...
This Component created by us, contains the **Logo** of the TCET Opensource Organisation.
  ...
  - `<h2>` tag is created by us to display the name of the Orgnisation.

:::tip
The Logo of the Orgnisation can be updated by changing **img src** pathlink or the image in that path. 
::: 

### Footlinks Component 

This Component produce by us, contains the **Footlinks** of the TCET Opensource Organisation.
...
This Component created by our team, consists of Copyright text of the Organisation.
...
:::info
The Copyright Text may be converted into accessible text with link to the Copyright page of the Organisation.
:::

### Social Media Component 

This Component contains various social media links of TCET Open Source Organisation.
...
2. The `<a>` tag is used by us to display LinkedIn Platform link in **href** of TCET OpenSource Organisation .

3. Similarly using same syntax, we have linked different Social Media Platform Account of TCET OpenSource Organisation for contact process of user.
...
After successfully implementing the Footer component of the [**TCET Linux Website**](https://linux.tcetmumbai.in/) , the next step is to move forward with the implementation of the Copy to Clipboard component.
