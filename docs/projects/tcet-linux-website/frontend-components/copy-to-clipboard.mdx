...
:::tip
You can visit
1. [CopyToClipboard.tsx](https://github.com/tcet-opensource/tcet-linux-website/blob/main/src/components/CopyToClipboard.tsx) github file.

2. [Verify Section](https://linux.tcetmumbai.in/#verify) of the TCET Linux website to see the application of the component.
