...
2. This is a *React component* called `Navbar` implemeented by us that represents a navigation bar elements with responsive behavior. Inside the component, we have defined an **Array** called `navlinks` that contains objects representing different navigation links.
...
### Navlinks Section
  ...
  This section consists of Navlinks of the Navbar of TCET Linux website.
   ...
   3. We created a **Get Started** icon using `<button>` which hovers the user to **Installation Guide** 
     ...
     ``` jsx title="Navbar.jsx" {2-21} showLineNumbers
           **\\ Logo code  
...
**The Mobile View can be scene like this **

import mobilenav from "/docs/projects/tcet-linux-website/assets/mobilenav.jpg";

<figure>
    <img src={mobilenav} style={{ border: "2px solid gray"}} />
    <center><b><figcaption>Mobile Navbar Section</figcaption></b></center>
</figure>


The [**Navbar Section**](navbar) is succesfully executed! Let's move on and see how we created the [**Footer Section**](footer) of the TCET Linux Website.
