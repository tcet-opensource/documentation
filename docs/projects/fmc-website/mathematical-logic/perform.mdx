...
```script title="script.js"{2-6} showLineNumbers
function perform(){
...
_We have successfully understood the [**Perform**](perform) function! Let's move on and understand the [**Table Updater**](table-updater) function of the **[Fill My Cycle](fillmycycle.tcetmumbai.in/)**._