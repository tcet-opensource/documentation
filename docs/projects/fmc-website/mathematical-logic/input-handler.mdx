...
```script title="script.js"{2-9,15,18,21-22,24-25} showLineNumbers
function expkeyup(){
...
_We have successfully understood the [**Input Handler**](input-handler) function! Let's move on and understand the [**Table Calculator**](table-calculator) function of the **[Fill My Cycle](fillmycycle.tcetmumbai.in/)**._