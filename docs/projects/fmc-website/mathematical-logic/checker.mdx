...
_We have succesfully understood the [**Checker**](checker) function! Let's move on and understand the [**Average**](average) fucntion of the **[Fill My Cycle](fillmycycle.tcetmumbai.in/)**._
