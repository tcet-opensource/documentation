...
_We have successfully understood the [**Table Row Updater**](table-row-updater) function! Let's move on and understand the [**Input Handler**](input-handler) function of the **[Fill My Cycle](fillmycycle.tcetmumbai.in/)**._