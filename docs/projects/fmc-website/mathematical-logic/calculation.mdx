...
_We have successfully understood the [**Calculation**](calculation) function! Let's move on and understand the [**Checker**](checker) function of the **[Fill My Cycle](fillmycycle.tcetmumbai.in/)**._
