...
_We have successfully understood the [**Table Transformatio**](table-transformation) function! Let's move on and understand the [**Page Interaction**](page-interaction) function of the **[Fill My Cycle](fillmycycle.tcetmumbai.in/)**._