...
## Cycle-result Table explanation
We have used HTML program for this component.<br />
...
2. class : We have used class attribute to apply a CSS class to the cells.
...
```
:::tip
Similarly we have made next column , total and average column. 
:::


4. Cycle-Result picture : 
...
After successfully implementing the **[Cycle-Result](cycle-result)** component of the **[Fill my cycle](https://fillmycycle.tcetmumbai.in/#result)** website, the next step we did was to move forward with the implementation of **[button-section](button-section)** component.
