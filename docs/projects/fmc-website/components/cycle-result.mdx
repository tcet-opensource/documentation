...
After successfully implementing the **[Cycle Result](cycle-result)** component of the **[Fill my cycle](https://fillmycycle.tcetmumbai.in/#result)** website, the next step we did was to move forward with the implementation of **[button instructions](button-instructions)** component.
