...
```jsx title="index.astro" {4-5,8-13} showLineNumbers
    {/*Nav as */}
...
**Here's the implemented code:**
 ...
 ```jsx title="index.astro" {3-4,6-10} showLineNumbers
...
import pic6 from "/docs/projects/resume-screener-website/assets/footer.jpg";
