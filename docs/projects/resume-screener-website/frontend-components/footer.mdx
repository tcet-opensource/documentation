...
import pic3 from "/docs/projects/resume-screener-website/assets/fsocial.jpg";
...
_After successfully implementing the **[Footer](footer)** component of the **[RS (Resume Screener)](https://rs.tcetmumbai.in/)** website, we were ready with out frontend part of the website. Next, we will be seeing the about section of **[TCET Linux](https://linux.tcetmumbai.in/)** website._
