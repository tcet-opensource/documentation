...
2. We then created a section element `section` that would represtent the content section. Under this we assigned CSS classes to introduce the required details. 
...
```jsx title="aboutUs.astro"
   <section class="w-full bg-[#0C1030] box-border flex justify-between gap-6 lg:gap-12  flex-col lg:flex-row p-4 lg:p-16 ">
```
**On implimentation, the implimented changes would look like this:**
...
**Once complied, finally the about us section would look like:**
