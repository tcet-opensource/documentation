...
* Guidelines and ATS resume template* In this segment  students are familiarised with different guidelines for regarging  resume and ways to improve it.
...
* ATS Resume Scan and Features* The need for a resume scan is to get an accurate report on the quality and quantity of the resumes.
